  ...
  return (
    ...
    <RevealOnScroll>
      <div className="text-center z-10 px-4">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-yellow-400 bg-clip-text text-transparent leading-right">
            Hi, I'm Louan
        </h1>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a 
              ...
              className="border border-blue-500/50 px-6 py-3 rounded font-medium
                          ...
                          hover:bg-blue-500/10 hover:border-yellow-500"
          >
            Contact Me
          </a>
        </div>
